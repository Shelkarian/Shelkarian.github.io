...
3.  Появляется прогресс-бар (зеленый который).
    ...
    * Под тушей появляется пятно крови. При каждом цикле разделки лужа расширяется
4.  **Результат:**
    * Туша исчезает.
...
1.  **Сковорода (Жарка):**
    * Ставится на плиту
    * Позволяет использовать масло/жир.
...
| :--- | :--- | :--- | :--- |
| **Кастрюля** | Кипение | **Оверлей:** Анимация кипения.|
| **Сковорода** | Жарка | Мелкие желтые/белые пиксели (брызги жира/масла), разлетающиеся в стороны. |
| **Сковорода** | Сгорание | Густой черный дым. |
| **Коптильня** | Работает | Из щелей конструкции идет тонкая струйка серого дыма. Дым должен быть не густым, ленивым |
| **Бочка** | Открытие | Анимация отодвигания крышки при открытии |
...
| **Глиняный горшок** | Печь | Печь | **Тушение.** Герметичен. Медленно нагревается, но долго держит тепло. |
| **Котел** | Плита, тренога | Плита, костер | **Варка.** Вмещает много жидкости. |
...
| :--- | :--- | :--- | :--- |
| **Очаг / Костер** | Дрова, Уголь | 1 Тренога / 1 Вертел | Базовый источник тепла. Дает свет. Вызывает дым в помещении |
| **Каменная печь** | Дрова | 4 предмета (аля горшки) | Требует предварительного прогрева. Имеет инерцию тепла. Идеально для выпечки |
| **Кухонная плита** | Уголь | 2 предмета (Кастрюли/Сковороды) | Регулируемый нагрев. |
| **Коптильня** | Опилки, щепа | 10 нарезанных предметов (на крюки) | Самый долгий процесс. Консервирует еду надолго. |
| **Бочка для засолки**| Соль | 5 единиц еды | Не требует тепла. Работает только при закрытой крышке. Еда внутри не гниет, пока есть соль. |
| **Сушильная стойка** | Ветер (пассивно) | 2 предмета (веревки) | В помещениях работает хуже. Рядом с огнем работает быстрее. |
| **Разделочный стол**| — | 1 Туша | Дает бонус к качеству разделки. Предотвращает разлив крови на пол. |

### Таблица 3: Инструменты обработки
*Чем игрок воздействует на предметы.*

| Инструмент | Функция | Описание |
| :--- | :--- | :--- |
| **Тесак** | Разделка | Высокий шанс получить все ресурсы. Бонус к скорости разделки больших туш. |
| **Нож** | Нарезка / Разделка | Универсален. Нарезка хлеба, сыра, овощей. |
...
| **Коза** | Козлятина | Рога, Молоко, Жесткая шкура | Жесткое мясо. Требует долгой варки, инаеч хуйня. |
| **Курица** | Птица | Перья, Яйца | База. Готовится очень быстро. |
| **Гусь** | Жирная птица | Пух, Гусиный жир | Деликатес. Жир используется в медицине. |
| **Кролик** | Крольчатина | Заячья лапка, Шкурка | Жареный почти не дает сытости, нужно тушить с овощами. |
...
| :--- | :--- | :--- | :--- |
| **Благородный олень** | Благородное мясо | Рога (огромные), Шкура | Королевская еда. |
| **Вепрь** | Вепрятина | Клыки, Жесткая щетина | Очень сытное мясо, но долго готовится. |
| **Медведь** | Медвежатина | Мех, Желчь, Жир | Мясо нужно **очень** долго варить (риск паразитов). Желчь используется как ингредиент алхимии. |
| **Волк** | Волчатина | Волчья шкура, Клыки | Жесткое, жилистое мясо. Только на вяление или в суп с кучей специй (аля рвота). |
| **Лиса** | Лисье мясо | Рыжий мех (Ценный) | Невкусное. Если съесть жареным, то тошнота. Нужно сильно солить. |
